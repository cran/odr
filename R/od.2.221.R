...
#' @param q.b The number of covariates in the mediator model (except the treatment indicator).
#' @param q.a The  number of covariates in the outcome model (except the treatment indicator and the mediator).
