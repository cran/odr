...
This package is a tool to identify the optimal sample allocation in experimental studies such that statistical power is maximized under a fixed budget. The current version covers designs detecting main and mediation effects.
...
sample size will be determined by total budget or power once all other parameters are decided, and
- the proportion of units to be assigned to the treatment condition 
